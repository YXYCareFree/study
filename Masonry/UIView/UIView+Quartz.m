...
-(void)drawRectangle:(CGRect)rect
{
    ...
    [self pathwithFrame:rect withRadius:0 pathRef:pathRef];
...
-(void)drawRectangle:(CGRect)rect withRadius:(float)radius
{
    CGContextRef     context = UIGraphicsGetCurrentContext();
    CGMutablePathRef pathRef = CGPathCreateMutable();
    [self pathwithFrame:rect withRadius:radius pathRef:pathRef];
...
-(void)pathwithFrame:(CGRect)frame withRadius:(float)radius pathRef:(CGMutablePathRef)pathRef
{
