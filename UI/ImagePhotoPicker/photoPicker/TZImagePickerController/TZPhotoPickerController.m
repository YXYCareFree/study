...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle: (@"lib_photopicker_cancel", @"取消") style:UIBarButtonItemStylePlain target:self action:@selector(cancel)];
...
- (void)configBottomToolBar {
    ...
    [_okButton setTitle: (@"lib_photopicker_confirm", @"确定") forState:UIControlStateNormal];
    [_okButton setTitle: (@"lib_photopicker_confirm", @"确定") forState:UIControlStateDisabled];
