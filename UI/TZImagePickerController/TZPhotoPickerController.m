...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:LocatizedStringForkey(@"lib_photopicker_cancel", @"取消") style:UIBarButtonItemStylePlain target:self action:@selector(cancel)];
...
- (void)configBottomToolBar {
    ...
    [_previewButton setTitle:LocatizedStringForkey(@"lib_photopicker_preview", @"预览") forState:UIControlStateNormal];
    [_previewButton setTitle:LocatizedStringForkey(@"lib_photopicker_preview", @"预览") forState:UIControlStateDisabled];
    ...
    _okButton.frame = CGRectMake(self.view.tz_width - 60 - 12, 3, 60, 44);
    _okButton.titleLabel.font = [UIFont systemFontOfSize:16];
    [_okButton addTarget:self action:@selector(okButtonClick) forControlEvents:UIControlEventTouchUpInside];
    [_okButton setTitle:LocatizedStringForkey(@"lib_photopicker_confirm", @"确定") forState:UIControlStateNormal];
    [_okButton setTitle:LocatizedStringForkey(@"lib_photopicker_confirm", @"确定") forState:UIControlStateDisabled];
    ...
    _numberImageView.frame = CGRectMake(self.view.tz_width - 72 - 24, 12, 26, 26);
