...
//@implementation UIViewController(presentHook)
//
//
...
//    {
//        [self safePresentModalViewController:ctr animated:ani];
//    }else
//    {
//        UINavigationController * nav = [[UINavigationController alloc] initWithRootViewController:ctr];
//        [self safePresentModalViewController:nav animated:YES];
//    }
//}
//
//+ (void)load
//{
//    method_exchangeImplementations(class_getInstanceMethod(self, @selector(presentModalViewController:animated:)),class_getInstanceMethod(self, @selector(safePresentModalViewController:animated:)));
//}
//@end
