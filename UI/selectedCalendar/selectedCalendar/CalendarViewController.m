...
@property (nonatomic, strong)  CollectionViewCell * startDayCell;

@property (nonatomic, strong)  CollectionViewCell * endDayCell;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString * str = [self.headerDateFormatter stringFromDate:[self firstOfMonthForSection:indexPath.section]].uppercaseString;
    NSLog(@"%@", [NSString stringWithFormat:@"%@ %@", cell.dateLabel.text, str]);
    [self initSelectDay];
}
...
- (void)initSelectDay{
    ...
    NSLog(@"_startIndexPath.section===%ld, _endIndexPath.section===%ld", _startIndexPath.section, _endIndexPath.section);
