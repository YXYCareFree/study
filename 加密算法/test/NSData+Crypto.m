...
{
    return [self TripleDES:key encryptOrDecrypt:kCCEncrypt];
}

- (NSData *)TripleDESDecryptWithKey:(NSString *)key
{
    return [self TripleDES:key encryptOrDecrypt:kCCDecrypt];
}

-(NSData *)TripleDES:(NSString*)key encryptOrDecrypt:(CCOperation)encryptOrDecrypt
{
    ...
    {
        NSData *EncryptData = [GTMBase64 decodeData:self];
